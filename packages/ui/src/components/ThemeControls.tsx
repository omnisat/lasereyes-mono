...
export default function ThemeControls() {
  ...
  const getDarkModeIcon = () => {
    switch (darkMode) {
      ...
      case 'manual':
        return isDark ? <Moon className="lem-h-4 lem-w-4" /> : <Sun className="lem-h-4 lem-w-4" />
      case 'disabled':
      ...
      <CardContent className="lem-space-y-4">
        ...
        <div className="lem-space-y-2">
          ...
          <div className="lem-p-3 lem-bg-muted lem-rounded lem-text-xs lem-space-y-1">
            ...
            <div>
              State: <span className="lem-font-mono">{isDark ? 'dark' : 'light'}</span>
            </div>
            <div>
              Primary:{' '}
        ...
        {/* Reset Button */}
        <Button variant="outline" size="sm" onClick={resetTheme} className="lem-w-full">
          Reset to Default
        </Button>
      </CardContent>
    </Card>
