        ...
        <Card className="overflow-hidden">
          <CardContent className="p-6">
            <p className="text-lg leading-relaxed">
              The <code>useLaserEyes</code> hook is your gateway to Bitcoin wallet integration in
              React. It provides a simple, yet powerful interface to connect wallets, send
              transactions, and manage Bitcoin-related functionality in your application.
            </p>
          </CardContent>
        </Card>
      </section>
