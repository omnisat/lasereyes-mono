    ...
    <div className="space-y-10">
        ...
        <Card className="overflow-hidden">
          <CardContent className="p-6">
            <p className="text-lg leading-relaxed">
              LaserEyes provides seamless integration with all major Bitcoin wallets through a unified interface. 
              Simply import the wallet constants and use them with the <code>connect</code> method from <code>useLaserEyes</code>.
            </p>
          </CardContent>
        </Card>
      </section>
      ...
      <section className="space-y-6">
        ...
        <div className="grid gap-6 md:grid-cols-2">
          {wallets.map((wallet) => (
            <Card key={wallet.id} className="group relative overflow-hidden transition-all duration-300 hover:border-orange-500/30 hover:shadow-lg hover:shadow-orange-500/5">
  ...
  return (
    <div className="space-y-8">
      <div className="relative overflow-hidden rounded-lg border bg-gradient-to-br from-orange-500/10 via-background to-background p-8">
        ...
        <Badge variant="secondary" className="mb-4">Wallet Integration</Badge>
