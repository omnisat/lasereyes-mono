        ...
        <Card className="overflow-hidden">
          <CardContent className="p-6">
            <p className="text-lg leading-relaxed">
              The LaserEyes Core API provides a powerful foundation for building
              Bitcoin applications. It's designed to be flexible, type-safe, and
              framework-agnostic, making it suitable for any JavaScript or
              TypeScript project.
            </p>
          </CardContent>
        </Card>
        ...
        <div className="grid gap-6 sm:grid-cols-2">
          <Card className="overflow-hidden">
            <CardContent className="p-6">
              ...
              <p className="text-muted-foreground mb-4">
                The core API is designed to work with any JavaScript framework
                or vanilla JS project. It provides the foundation that
                framework-specific packages build upon.
              </p>
          ...
          <Card className="overflow-hidden">
            <CardContent className="p-6">
              ...
              <p className="text-muted-foreground mb-4">
                LaserEyes is built with extensibility in mind, allowing you to
                customize and extend its functionality to meet your specific
                needs.
              </p>
              <ul className="space-y-2 text-sm text-muted-foreground">
                <li className="flex items-center">
    ...
    <div className="space-y-8">
      <div className="relative overflow-hidden rounded-lg border bg-gradient-to-br from-orange-500/10 via-background to-background p-8">
        ...
        <p className="text-xl mb-6 max-w-2xl text-muted-foreground">
          Explore the foundational building blocks of LaserEyes and learn how to
          leverage its powerful features in your applications.
        </p>
