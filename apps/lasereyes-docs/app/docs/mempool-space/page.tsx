    ...
    <div className="space-y-8">
      <div className="relative overflow-hidden rounded-lg border bg-gradient-to-br from-blue-600/20 via-background to-background p-8">
        ...
        <p className="text-xl mb-8 max-w-2xl text-muted-foreground">
          The most advanced Bitcoin mempool visualizer and blockchain explorer. Trusted by the
          community for real-time network insights.
        </p>
        ...
        <Card className="overflow-hidden border-blue-500/20">
          <CardContent className="p-6">
            ...
            <p className="text-muted-foreground mb-4">
              mempool.space is an open-source project supported by the Bitcoin community. Run your
              own instance or contribute to the project!
            </p>
            <Link
