        ...
        <Card className="overflow-hidden">
          <CardContent className="p-6">
            <p className="text-lg leading-relaxed">
              Let's build a simple application with LaserEyes to connect a
              wallet, display the balance, and send a transaction. This example
              will demonstrate the core features of LaserEyes in a practical
              way.
            </p>
          </CardContent>
        </Card>
  ...
  try {
    ...
    setLoading(false)
        ...
        <WarningBox title="Testing Transactions" className="mt-6">
          <p>
            When testing transactions, it's recommended to use a testnet network
            to avoid using real BTC. You can configure LaserEyes to use testnet
            by setting <code>network: TESTNET</code> in the provider config.
          </p>
        </WarningBox>
      </section>
        ...
        <Card className="overflow-hidden">
          ...
          <CardContent className="p-6">
            <p className="mb-6 text-muted-foreground">
              LaserEyes also supports working with Bitcoin Ordinals and
              inscriptions. Here's a complete example showing how to list
              inscriptions and create new ones:
            </p>
            <CodeBlock
              language="tsx"
    ...
    <div className="space-y-8 w-full max-w-md">
      ...
      <div className="bg-gray-100 dark:bg-gray-800 p-4 rounded">
        ...
        <WarningBox title="Inscription Fees" className="mt-6">
          <p>
            Creating inscriptions requires paying Bitcoin network fees. Make
            sure you have enough BTC in your wallet to cover both the
            inscription and the network fees. The exact fee will depend on
            network conditions and inscription size.
          </p>
        </WarningBox>
    ...
    <div className="space-y-8">
      <div className="relative overflow-hidden rounded-lg border bg-gradient-to-br from-orange-500/10 via-background to-background p-8">
        ...
        <p className="text-xl mb-6 max-w-2xl text-muted-foreground">
          Build your first Bitcoin application with LaserEyes in this
          step-by-step guide.
        </p>
