...
import { Code2, Database, Rocket, Shield, Wallet, Zap } from 'lucide-react'
    ...
    <div className="space-y-8">
      <div className="relative overflow-hidden rounded-lg border bg-gradient-to-br from-orange-500/10 via-background to-background p-8">
        ...
        <p className="text-xl mb-6 max-w-2xl text-muted-foreground">
          A powerful wallet connect library making it easier than ever to build and maintain Bitcoin
          Ordinal Web Apps.
        </p>
      </div>
    ...
    <div className="space-y-10">
        ...
        <Card className="overflow-hidden">
          <CardContent className="p-6">
            <p className="text-lg leading-relaxed">
              LaserEyes provides a unified interface to interact with multiple Bitcoin wallets,
              making it simple to add wallet connectivity to your web applications.
            </p>
          </CardContent>
        </Card>
      </section>
      ...
      <section className="space-y-6">
        ...
        <Card className="overflow-hidden">
          <CardContent className="p-6">
            <p className="text-lg leading-relaxed">
              Building Bitcoin web applications can be challenging due to the variety of wallet
              providers and their different APIs. LaserEyes solves this problem by providing a
              unified interface that works with all major Bitcoin wallets.
            </p>
          </CardContent>
        </Card>
      </section>
