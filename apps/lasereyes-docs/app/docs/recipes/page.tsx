  ...
  return (
    <div className="max-w-3xl mx-auto py-8">
      ...
      <p className="text-lg mb-6">
        Welcome to the LaserEyes recipe book! Here you'll find complete
        solutions for common Bitcoin app scenarios. These recipes are like TV
        dinners, but for code - just heat and serve!
      </p>
      ...
      <div className="grid gap-6 md:grid-cols-2">
        ...
        >
          ...
          <p className="text-muted-foreground mb-4">
            Create a donation page that accepts Bitcoin payments
          </p>
          <span className="text-sm px-2 py-1 bg-green-100 dark:bg-green-900 rounded">
            Beginner Friendly
          </span>
        </Link>
        ...
        >
          ...
          <p className="text-muted-foreground mb-4">
            Build a complete transaction history viewer
          </p>
        ...
        >
          ...
          <p className="text-muted-foreground mb-4">
            Create a dashboard to monitor multiple Bitcoin wallets
          </p>
          <span className="text-sm px-2 py-1 bg-red-100 dark:bg-red-900 rounded">
            Advanced
          </span>
        </Link>
        ...
        >
          ...
          <p className="text-muted-foreground mb-4">
            Add Lightning Network support to your LaserEyes app
          </p>
          <span className="text-sm px-2 py-1 bg-purple-100 dark:bg-purple-900 rounded">
            Experimental
          </span>
        </Link>
      </div>
      ...
      <p className="mb-4">
        Think of these recipes as starting points - feel free to add your own
        special sauce!
      </p>
      ...
      <div className="p-4 bg-orange-100 dark:bg-orange-900 rounded-lg mt-8">
        ...
        <p>
          The best Bitcoin apps are like good pizza - they have a clean UI,
          deliver value quickly, and don't require a PhD to understand. Keep it
          simple!
        </p>
      </div>
    </div>
