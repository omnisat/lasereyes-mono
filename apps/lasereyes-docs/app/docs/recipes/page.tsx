  ...
  return (
    <div className="max-w-3xl mx-auto py-8">
      ...
      <p className="text-lg mb-6">
        Welcome to the LaserEyes recipe book! Here you'll find complete solutions for common Bitcoin
        app scenarios. These recipes are like TV dinners, but for code - just heat and serve!
      </p>
      ...
      <p className="mb-4">
        Think of these recipes as starting points - feel free to add your own special sauce!
      </p>

      <div className="p-4 bg-orange-100 dark:bg-orange-900 rounded-lg mt-8">
        <p className="font-semibold">🔥 Hot Tip:</p>
        <p>
          The best Bitcoin apps are like good pizza - they have a clean UI, deliver value quickly,
          and don't require a PhD to understand. Keep it simple!
        </p>
      </div>
    </div>
  )
