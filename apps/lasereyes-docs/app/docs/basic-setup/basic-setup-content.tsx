  ...
  return (
    <>
      ...
      <p className="text-lg mb-4">
        This guide will walk you through the basic setup of LaserEyes in your application.
      </p>

      <Heading level={2}>React Setup</Heading>
      <p className="mb-6">
        If you're using React, LaserEyes provides a convenient provider component and hooks to make
  ...
  return (
    ...
    >
      ...
      <WarningBox title="Development API Keys" className="mt-4 mb-6">
        LaserEyes includes development API keys for Maestro and Sandshrew, but these are
        rate-limited. For production applications, you should register for your own API keys.
      </WarningBox>

      <Heading level={3}>Using the Hook</Heading>
      <p className="mb-4">
        Once the provider is set up, you can use the <code>useLaserEyes</code> hook in any
        component:
      </p>
      <CodeBlock
        language="tsx"
...
function WalletConnect() {
  ...
  return (
    <div>
      ...
      <p className="mb-6">
        If you're not using React or want more control, you can use the core client directly:
      </p>
      <CodeBlock
        language="typescript"
        code={`import { 
...
function cleanup() {
  client.dispose()
      ...
      <p className="mb-6">
        LaserEyes supports multiple Bitcoin networks. You can specify the network in the
        configuration:
      </p>
      <CodeBlock
        language="typescript"
...
const testnetConfig = createConfig({ network: TESTNET })`}
      ...
      <p className="mb-6">
        LaserEyes uses a DataSource system to interact with Bitcoin data providers. You can
  ...
  dataSources: {
    ...
    esplora: 'https://blockstream.info/api',
      ...
      <p className="mb-6">
        Now that you have set up LaserEyes, you can start building your Bitcoin web application:
      </p>
