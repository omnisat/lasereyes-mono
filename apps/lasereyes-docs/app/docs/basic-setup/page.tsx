      ...
      <table className="w-full border-collapse">
        ...
        <tbody className="divide-y">
          <tr className="bg-card transition-colors hover:bg-muted/50">
            <td className="p-4">
              <code className="rounded bg-muted px-2 py-1">network</code>
            </td>
            <td className="p-4">Bitcoin network to connect to</td>
            <td className="p-4">
              <code className="rounded bg-muted px-2 py-1">MAINNET</code>
            </td>
          </tr>
          <tr className="bg-card transition-colors hover:bg-muted/50">
            <td className="p-4">
              <code className="rounded bg-muted px-2 py-1">dataSources</code>
            </td>
          ...
          <tr className="bg-card transition-colors hover:bg-muted/50">
            <td className="p-4">
              <code className="rounded bg-muted px-2 py-1">autoConnect</code>
            </td>
            <td className="p-4">
              ...
              {[
                {
                  ...
                  description:
                    'Learn about all the features provided by the useLaserEyes hook',
                  id: 'use-laser-eyes',
                },
                {
                  ...
                  description:
                    'Explore the different wallet providers and their capabilities',
                  id: 'wallet-providers',
                },
                {
    ...
    <div className="space-y-8">
      <div className="relative overflow-hidden rounded-lg border bg-gradient-to-br from-orange-500/10 via-background to-background p-8">
        ...
        <p className="text-xl mb-6 max-w-2xl text-muted-foreground">
          Get started with LaserEyes in your React application with this
          step-by-step guide.
        </p>
