  ...
  return (
    <div className="max-w-3xl mx-auto py-8">
      ...
      <p className="text-lg mb-6">
        Track Bitcoin transactions with the precision of a blockchain bloodhound and the patience of
        a HODLer in a bear market.
      </p>
      ...
      <p className="mb-4">
        You want to track the status of Bitcoin transactions in real-time, showing confirmations as
        they happen. Manually polling for updates is tedious and inefficient.
      </p>
      ...
      <p className="mb-4">
        LaserEyes provides a simple way to track transactions with automatic updates:
      </p>
  ...
  return (
    <div className="p-4 border rounded-lg">
      ...
      <ol className="list-decimal pl-6 space-y-2 mb-6">
        ...
        <li>
          A progress bar visualizes the confirmation progress (6+ is typically considered
          "confirmed")
        </li>
      </ol>
  ...
  return (
    <div className="space-y-4">
      ...
      <div className="p-4 bg-blue-100 dark:bg-blue-900 rounded-lg mt-8">
        ...
        <p>
          The average Bitcoin transaction takes about 10 minutes to get its first confirmation.
          That's just enough time to make a cup of coffee or explain to your grandma what a
          blockchain is (results may vary).
        </p>
      </div>
    </div>
  )
