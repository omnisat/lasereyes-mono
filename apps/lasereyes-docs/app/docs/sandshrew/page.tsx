    ...
    <div className="space-y-8">
      <div className="relative overflow-hidden rounded-lg border bg-gradient-to-br from-emerald-600/20 via-background to-background p-8">
        ...
        <p className="text-xl mb-8 max-w-2xl text-muted-foreground">
          High-performance, open-source Bitcoin indexer and API. Built for speed, reliability, and
          scalability.
        </p>
    ...
    sandshrew: {
      ...
      priority: 1  // Set as primary data source
            ...
            <div className="mt-4 text-sm text-muted-foreground">
              Get your API key at{' '}
              <a href="https://sandshrew.io" className="text-emerald-500 hover:text-emerald-400">
                sandshrew.io
              </a>
            </div>
          </CardContent>
        ...
        <Card className="overflow-hidden border-emerald-500/20">
          <CardContent className="p-6">
            ...
            <p className="text-muted-foreground mb-4">
              Sandshrew is open source under the MIT license. We welcome contributions from the
              community!
            </p>
            <Link
