    ...
    <div className="space-y-8">
      <div className="relative overflow-hidden rounded-lg border bg-gradient-to-br from-emerald-500/10 via-background to-background p-8">
        ...
        <p className="text-xl mb-6 max-w-2xl text-muted-foreground">
          Learn how to interact with BRC-20 tokens using LaserEyes - fetch balances, send tokens,
        ...
        <Card className="overflow-hidden">
          <CardContent className="p-6">
            <p className="text-lg leading-relaxed">
              LaserEyes provides comprehensive support for BRC-20 tokens, allowing you to easily
              fetch balances, send tokens, and manage transfers through a unified interface.
            </p>
          </CardContent>
        </Card>
      </section>
          ...
          <CardContent className="p-6 space-y-4">
            <div>
              ...
              <p className="text-muted-foreground">
                Always validate token balances before attempting transfers. Check both the
                transferable and available amounts.
              </p>
            </div>
            ...
            <div>
              ...
              <p className="text-muted-foreground">
                Implement proper error handling for token operations. Network issues, insufficient
                balances, or wallet rejections should be handled gracefully.
              </p>
            </div>
            ...
            <div>
              ...
              <p className="text-muted-foreground">
                Show appropriate loading states during token operations. Both fetching balances and
            ...
            <div>
              ...
              <p className="text-muted-foreground">
                Consider implementing fallback data sources for token operations. LaserEyes supports
