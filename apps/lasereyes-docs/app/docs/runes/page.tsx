    ...
    <div className="space-y-8">
      <div className="relative overflow-hidden rounded-lg border bg-gradient-to-br from-purple-500/10 via-background to-background p-8">
        ...
        <p className="text-xl mb-6 max-w-2xl text-muted-foreground">
          Learn how to interact with Bitcoin Runes using LaserEyes - fetch balances, send tokens,
          and more.
        </p>
      </div>
        ...
        <Card className="overflow-hidden">
          <CardContent className="p-6">
            <p className="text-lg leading-relaxed">
              LaserEyes provides comprehensive support for Bitcoin Runes, allowing you to easily
              fetch balances, send tokens, and interact with the Runes protocol through a unified
              interface.
            </p>
          </CardContent>
        </Card>
          ...
          <CardContent className="p-6 space-y-4">
            <div>
              ...
              <p className="text-muted-foreground">
                Always implement proper error handling for Rune operations. Network issues,
                insufficient balances, or wallet rejections should be handled gracefully.
              </p>
            </div>
            ...
            <div>
              ...
              <p className="text-muted-foreground">
                Show appropriate loading states during Rune operations. Both fetching balances and
            ...
            <div>
              ...
              <p className="text-muted-foreground">
                Always validate Rune balances before attempting transfers. Check both the balance
                amount and if the user owns the Rune.
              </p>
            </div>
            ...
            <div>
              ...
              <p className="text-muted-foreground">
                Consider implementing fallback data sources for Rune operations. LaserEyes supports
                multiple data providers to ensure reliability.
              </p>
            </div>
          </CardContent>
        </Card>
