...
import { ArrowRight, Bitcoin, Bot, Palette, Zap } from 'lucide-react'
          ...
          <CardContent className="grid gap-4 p-6 sm:grid-cols-2">
            ...
            <div className="flex flex-col justify-center">
              ...
              <p className="text-sm text-muted-foreground">
                Navigate to your new project directory and start the development server to see your
                Bitcoin app in action.
              </p>
            </div>
          </CardContent>
        </Card>
                ...
                <tbody>
                  <tr className="border-b">
                    <td className="py-3 px-4">
                      <code className="rounded bg-muted px-2 py-1">-t, --template [name]</code>
                    </td>
                  ...
                  <tr className="border-b">
                    <td className="py-3 px-4">
                      <code className="rounded bg-muted px-2 py-1">--tailwind</code>
                    </td>
                    <td className="py-3 px-4">Install TailwindCSS (default: true)</td>
                  </tr>
                  <tr>
                    <td className="py-3 px-4">
                      <code className="rounded bg-muted px-2 py-1">--shadcn</code>
                    </td>
        ...
        <Card className="overflow-hidden">
          <CardContent className="p-6">
            ...
            <ol className="list-decimal pl-6 space-y-2 mb-6">
              ...
              <li>
                Commit your changes:{' '}
                <code className="rounded bg-muted px-2 py-1">git commit -m 'Add some feature'</code>
              </li>
              <li>
                Push to the branch:{' '}
                <code className="rounded bg-muted px-2 py-1">
    ...
    <div className="space-y-8">
      <div className="relative overflow-hidden rounded-lg border bg-gradient-to-br from-orange-500/10 via-background to-background p-8">
        ...
        <p className="text-xl mb-6 max-w-2xl">
          The fastest way to scaffold modern Bitcoin applications with Next.js and LaserEyes wallet
          integration.
        </p>
