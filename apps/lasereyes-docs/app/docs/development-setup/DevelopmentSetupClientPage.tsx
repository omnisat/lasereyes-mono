            ...
            <div className="space-y-4">
              <div className="rounded-md bg-muted p-4">
                ...
                <ul className="space-y-2 text-sm text-muted-foreground">
                  ...
                  <li>
                    <strong>Node.js version:</strong> Use version in{' '}
                    <code>.nvmrc</code>
                  </li>
                </ul>
              </div>
    ...
    <div className="space-y-8">
      <div className="relative overflow-hidden rounded-lg border bg-gradient-to-br from-purple-500/10 via-background to-background p-8">
        ...
        <p className="text-xl mb-6 max-w-2xl text-muted-foreground">
          Get your development environment ready to contribute to LaserEyes.
          Follow this guide to set up your workspace and start building.
        </p>
      </div>
