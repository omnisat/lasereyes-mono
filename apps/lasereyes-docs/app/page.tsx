...
import { ArrowRight, Bitcoin, Code, Layers, Shield, Wallet, Zap } from 'lucide-react'
              ...
              <div className="flex flex-col justify-center space-y-4 max-w-3xl mx-auto lg:mx-0 px-4 md:px-8 lg:px-12">
                <div className="space-y-2">
                  ...
                  <p className="max-w-[600px] text-muted-foreground md:text-xl text-center lg:text-left">
                    Connect to any Bitcoin wallet, handle transactions, and work with Ordinals &
                    BRC-20 tokens with just a few lines of code.
                  </p>
                </div>
          ...
          <div className="container px-4 md:px-6">
            ...
            <div className="flex justify-center mt-8">
              <Button asChild size="lg" className="group">
                <Link href="https://github.com/sponsors/omnisat" target="_blank" rel="noreferrer">
                  Become a Sponsor
            ...
            <div className="mx-auto grid max-w-5xl items-center gap-6 py-12">
              <div className="space-y-8 min-w-0">
                <div className="space-y-4">
                  ...
                  <CodeBlock language="bash" code={`npx create-lasereyes`} copyButton={true} />
                </div>
          ...
          <div className="container px-4 md:px-6">
            ...
            <div className="mx-auto max-w-5xl space-y-8">
              <WarningBox title="Production API Keys Warning">
                ...
                production applications, please register for your own API keys with Maestro and/or
                Sandshrew to ensure reliable service and avoid rate limiting issues.
              </WarningBox>
