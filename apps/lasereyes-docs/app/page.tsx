...
import { Bitcoin, Wallet, Zap, Shield, Code, Layers, ArrowRight } from "lucide-react"
// Add the import at the top with other imports
import { LaserEyesLogo, LEATHER, MAGIC_EDEN, OKX, OP_NET, ORANGE, OYL, PHANTOM, UNISAT, WIZZ, XVERSE } from "@omnisat/lasereyes-react"
                ...
                <div className="space-y-2">
                  <div className="flex flex-col items-center lg:items-start pl-0 md:pl-4 lg:pl-6">
                    ...
                    <h1 className="text-3xl font-bold tracking-tighter sm:text-5xl xl:text-6xl/none text-center lg:text-left">
                      <span className="gradient-text">Seamless Bitcoin Wallet Integration</span>
                    </h1>
                  </div>
                  ...
                  <p className="max-w-[600px] text-muted-foreground md:text-xl text-center lg:text-left">
                    Connect to any Bitcoin wallet, handle transactions, and work with Ordinals & BRC-20 tokens with just
                    a few lines of code.
                  </p>
                </div>
          ...
          <div className="container px-4 md:px-6">
            ...
            <div className="mx-auto max-w-5xl space-y-8">
              <WarningBox title="Production API Keys Warning">
                The API keys included with LaserEyes are intended for development purposes only. For production
                applications, please register for your own API keys with Maestro and/or Sandshrew to ensure reliable
                service and avoid rate limiting issues.
              </WarningBox>
          ...
          <div className="container px-4 md:px-6">
            ...
            <div className="mx-auto grid max-w-5xl gap-6 py-12 md:grid-cols-2 lg:grid-cols-3">
              ...
              <div className="group relative overflow-hidden rounded-xl border border-border/50 bg-card p-6 transition-all duration-300 hover:border-primary/20 hover:shadow-md hover:shadow-primary/5 flex flex-col items-center space-y-3">
                ...
                <p className="text-center text-muted-foreground">React hooks and components for seamless integration</p>
              </div>
              ...
              <div className="group relative overflow-hidden rounded-xl border border-border/50 bg-card p-6 transition-all duration-300 hover:border-primary/20 hover:shadow-md hover:shadow-primary/5 flex flex-col items-center space-y-3">
                ...
                <p className="text-center text-muted-foreground">Angular services and directives for enterprise apps</p>
              </div>
              ...
              <div className="group relative overflow-hidden rounded-xl border border-border/50 bg-card p-6 transition-all duration-300 hover:border-primary/20 hover:shadow-md hover:shadow-primary/5 flex flex-col items-center space-y-3">
                ...
                <svg viewBox="0 0 24 24" className="h-12 w-12 text-primary" fill="currentColor">
                  ...
                  <path
                    ...
                    opacity="0.7"
                  />
                  <path d="M3.925 2.373L14.07 16.486 8.83 6.39 3.925 2.373z" fill="currentColor" opacity="0.5" />
                </svg>
              ...
              <div className="group relative overflow-hidden rounded-xl border border-border/50 bg-card p-6 transition-all duration-300 hover:border-primary/20 hover:shadow-md hover:shadow-primary/5 flex flex-col items-center space-y-3">
                ...
                <p className="text-center text-muted-foreground">Support for more frameworks on the way</p>
              </div>
            </div>
          </div>
        </div>
